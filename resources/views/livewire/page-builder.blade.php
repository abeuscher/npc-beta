...
>
    ...
    <style>
        ...
        .widget-preview-scope .widget { overflow: hidden; }
        ...
        .widget-preview-scope h1 { font-size: 2.25rem; }
        .widget-preview-scope h2 { font-size: 1.875rem; }
        .widget-preview-scope h3 { font-size: 1.5rem; }
        .widget-preview-scope h4 { font-size: 1.25rem; }
        .widget-preview-scope h5 { font-size: 1.125rem; }
        .widget-preview-scope h6 { font-size: 1rem; }
        .widget-preview-scope p { margin: 0 0 1em; }
        .widget-preview-scope ul,
        .widget-preview-scope ol { margin: 0 0 1em; padding-left: 1.5em; }
        .widget-preview-scope a { color: var(--color-primary, #0172ad); text-decoration: underline; }
        .widget-preview-scope a:hover { opacity: 0.8; }
        .widget-preview-scope img { max-width: 100%; height: auto; }

        /* ── Buttons ─────────────────────────────────────────────────── */
        .widget-preview-scope .btn-group { display: flex; flex-wrap: wrap; gap: 0.75rem; }
        .widget-preview-scope .btn-group--left   { justify-content: flex-start; }
        .widget-preview-scope .btn-group--center { justify-content: center; }
        .widget-preview-scope .btn-group--right  { justify-content: flex-end; }
        .widget-preview-scope .btn {
        ...
        .widget-preview-scope .btn--primary {
            --btn-bg: var(--btn-primary-bg, var(--color-primary, #0172ad));
            --btn-color: var(--btn-primary-color, white);
        }
        .widget-preview-scope .btn--secondary {
            --btn-bg: var(--btn-secondary-bg, transparent);
            --btn-color: var(--btn-secondary-color, #374151);
            --btn-border-width: var(--btn-secondary-border-width, 1px);
            --btn-border-color: var(--btn-secondary-border-color, #d1d5db);
        }
        .widget-preview-scope .btn--icon-left,
        .widget-preview-scope .btn--icon-right { display: inline-flex; align-items: center; gap: 0.375em; }
        .widget-preview-scope .btn--icon-right { flex-direction: row-reverse; }

        /* ── Grid ────────────────────────────────────────────────────── */
        .widget-preview-scope .form-grid { display: grid; grid-template-columns: repeat(12, 1fr); gap: 1rem; }
        .widget-preview-scope .col-1  { grid-column: span 1; }
        .widget-preview-scope .col-2  { grid-column: span 2; }
        .widget-preview-scope .col-3  { grid-column: span 3; }
        .widget-preview-scope .col-4  { grid-column: span 4; }
        .widget-preview-scope .col-5  { grid-column: span 5; }
        .widget-preview-scope .col-6  { grid-column: span 6; }
        .widget-preview-scope .col-7  { grid-column: span 7; }
        .widget-preview-scope .col-8  { grid-column: span 8; }
        .widget-preview-scope .col-9  { grid-column: span 9; }
        .widget-preview-scope .col-10 { grid-column: span 10; }
        .widget-preview-scope .col-11 { grid-column: span 11; }
        .widget-preview-scope .col-12 { grid-column: span 12; }

        /* ── Utility ─────────────────────────────────────────────────── */
        .widget-preview-scope .text-muted { color: #6b7280; }
        .widget-preview-scope .text-sm { font-size: 0.875rem; line-height: 1.25rem; }
    </style>
    @endonce
