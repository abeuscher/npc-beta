    ...
    @teleport('body')
        ...
        >
            <div class="container mx-auto rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900">
                ...
                <div class="mb-5">
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Block Label</label>
                    <input
                        type="text"
                        wire:model="childAddLabel"
                        placeholder="e.g. Hero, About Us intro…"
                        autofocus
                        class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-primary-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                    >
                    <p class="mt-1 text-xs text-gray-400">Optional. If blank, auto-named by type.</p>
                </div>
                ...
                <div class="mt-5 flex justify-end">
                    <button
                        type="button"
                        wire:click="$set('showChildAddModal', false)"
