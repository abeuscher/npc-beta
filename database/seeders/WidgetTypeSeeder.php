    ...
    confirmation.addEventListener('input', check);
        ...
        WidgetType::updateOrCreate(
            ...
            [
                ...
                'config_schema'      => [
                    ...
                    ['key' => 'background_color', 'type' => 'color',  'label' => 'Background color',         'default' => '#000000', 'group' => 'appearance'],
                    ['key' => 'text_color',       'type' => 'color',  'label' => 'Text color',               'default' => '#ffffff', 'group' => 'appearance'],
        ...
        WidgetType::updateOrCreate(
            ...
            [
                ...
                'default_open'       => true,
                'config_schema'      => [
                    ['key' => 'num_columns',           'type' => 'number', 'label' => 'Number of columns', 'default' => 2, 'group' => 'content'],
                    ['key' => 'grid_template_columns', 'type' => 'text',   'label' => 'Column widths (e.g. 1fr 1fr)', 'default' => '1fr 1fr', 'group' => 'appearance'],
                ],
        ...
        WidgetType::updateOrCreate(
            ...
            [
                ...
                'config_schema'      => [
                    ...
                    ['key' => 'background_color',  'type' => 'color',   'label' => 'Background colour', 'default' => '#ffffff', 'group' => 'appearance'],
        ...
        WidgetType::updateOrCreate(
            ...
            [
                ...
                'config_schema'      => [
                    ...
                    ['key' => 'full_width',       'type' => 'toggle',  'label' => 'Full Width', 'default' => true, 'helper' => 'Extend edge-to-edge without content container', 'group' => 'appearance'],
                    ...
                    ['key' => 'overlay_opacity',  'type' => 'number',  'label' => 'Overlay Opacity', 'default' => 50, 'helper' => '0–100, rendered as percentage', 'group' => 'appearance'],
