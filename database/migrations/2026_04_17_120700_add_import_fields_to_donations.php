...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('donations', function (Blueprint $table) {
            $table->foreignUuid('import_source_id')->nullable()->after('ended_at')
            ...
            $table->index(['import_source_id', 'external_id'], 'donations_import_external_idx');
        });
    }
    ...
    {
        Schema::table('donations', function (Blueprint $table) {
            $table->dropIndex('donations_import_external_idx');
