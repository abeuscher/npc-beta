...
class EventResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\Tabs::make('event_tabs')->tabs([
                ...
                Forms\Components\Tabs\Tab::make('Details')->schema([
                    ...
                    Forms\Components\Select::make('recurrence_type')
                        ...
                        ->helperText('Dates are managed in the Dates tab below.'),
                ...
                Forms\Components\Tabs\Tab::make('Dates')->schema([
                    Forms\Components\Placeholder::make('dates_note')
                        ->label('')
                        ->content('Add and manage individual event dates in the Dates relation manager below the form.'),
                ]),
