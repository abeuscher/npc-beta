    ...
    protected function getReadOnlyHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('viewTicketPurchases')
                ...
                ->visible(fn () => auth()->user()?->can('view_any_transaction') && ! $this->getRecord()->is_free && $this->getRecord()->registrations()->exists()),
        ];
    }
        ...
        return [
            ...
            Actions\ActionGroup::make([
                ...
                Actions\Action::make('viewTicketPurchases')
                    ...
                    ->visible(fn () => ! $this->getRecord()->is_free && $this->getRecord()->registrations()->exists()),
