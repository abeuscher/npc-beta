...
| source | string | no | default: human; values: human, import, stripe_webhook, scrub_data (per `EventRegistration::ACCEPTED_SOURCES`). Origin discriminator — orthogonal to `status`. |
