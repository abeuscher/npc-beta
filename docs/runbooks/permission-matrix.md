...
| **ProductResource** | [`view_any_product`](../../plugins/Products/Filament/Resources/ProductResource.php#L19) (canDelete: no purchases attached) | allow* | allow | deny | deny | deny | allow | deny | deny | redirect |
