...
We are about to begin a new session: **103. QuickBooks Transaction Sync**.
...
3. Open `sessions/103. QuickBooks Transaction Sync.md` and read the session prompt carefully.
