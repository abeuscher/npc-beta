...
We are about to begin a new session: **127. Widget — Alternating Panels**.
...
3. Open `sessions/127. Widget — Alternating Panels.md` and read the session prompt carefully.
