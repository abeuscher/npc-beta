...
We are about to begin a new session: **144. Column Widget — Drag-and-Drop Reorder**.
...
3. Open `sessions/144. Column Widget — Drag-and-Drop Reorder.md` and read the session prompt carefully.
