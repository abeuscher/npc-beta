...
We are about to begin a new session: **105. QuickBooks Per-Type Account Mapping**.
...
3. Open `sessions/105. QuickBooks Per-Type Account Mapping.md` and read the session prompt carefully.
