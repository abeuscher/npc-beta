...
We are about to begin a new session: **136. Widget Edit & Preview Modes**.
...
3. Open `sessions/136. Widget Edit & Preview Modes.md` and read the session prompt carefully.
