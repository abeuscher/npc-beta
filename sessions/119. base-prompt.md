...
We are about to begin a new session: **119. Widget Picker — Categories, Page-Type Filtering & Search**.
...
3. Open `sessions/119. Widget Picker — Categories, Page-Type Filtering & Search.md` and read the session prompt carefully.
