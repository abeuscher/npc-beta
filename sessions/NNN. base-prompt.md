...
7. Open `sessions/NNN. Post-Incident Test Integrity — Stale-Stylesheet Drift Guard.md` and read it carefully — it carries the canonical findings table (scope is fixed there), the drift-guard design, the open questions, and the explicit deferred set.
