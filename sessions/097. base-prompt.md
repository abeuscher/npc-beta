We are about to begin a new session: **097. Header & Footer Widget System**.
...
3. Open `sessions/097. Header & Footer Widget System.md` and read the session prompt carefully.
