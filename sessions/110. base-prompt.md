...
We are about to begin a new session: **110. Data Retention & Cascading Delete Audit**.
...
3. Open `sessions/110. Data Retention & Cascading Delete Audit.md` and read the session prompt carefully.
