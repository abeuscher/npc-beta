...
We are about to begin a new session: **104. QuickBooks Customer Matching**.
...
3. Open `sessions/104. QuickBooks Customer Matching.md` and read the session prompt carefully.
