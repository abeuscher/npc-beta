We are about to begin a new session: **184. Sample Image Library & Demo Seeder Integration**.
...
3. Open `sessions/184. Sample Image Library & Demo Seeder Integration.md` and read the session prompt carefully.
