...
We are about to begin a new session: **140. Properties Panel & Config Split**.
...
3. Open `sessions/140. Properties Panel & Config Split.md` and read the session prompt carefully.
