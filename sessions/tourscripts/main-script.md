...
Memberships [Focus on menu heading]
...
Donations [Focus on menu heading]
...
Mailing Lists [Focus on menu heading]
...
Help System [Focus on help search box andd help icon ideally. If it an only be one theing then the search box is better.]
...
Conclusion [Remove focus and just put this in a modal at end with the links to the other tours.
