...
We are about to begin a new session: **118. Help System — Search, Standalone Pages & Related Articles**.
...
3. Open `sessions/118. Help System — Search, Standalone Pages & Related Articles.md` and read the session prompt carefully.
