...
We are about to begin a new session: **118. Demo Instance Configuration & Hardening**.
...
4. Open `sessions/118. Demo Instance Configuration & Hardening.md` and read the session prompt carefully.
