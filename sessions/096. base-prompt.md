We are about to begin a new session: **096. Per-Page SEO & Header Snippets**.
...
3. Open `sessions/096. Per-Page SEO & Header Snippets.md` and read the session prompt carefully.
