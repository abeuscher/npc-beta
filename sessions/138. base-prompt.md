...
We are about to begin a new session: **138. Widget JS Dependencies & Interactive Preview**.
...
3. Open `sessions/138. Widget JS Dependencies & Interactive Preview.md` and read the session prompt carefully.
