We are about to begin a new session: **099. Template System — Data Model & Migration**.
...
3. Open `sessions/099. Template System — Data Model & Migration.md` and read the session prompt carefully.
