...
- **Build/version discipline (load-bearing):** bump `VERSION` to `0.305.<iteration>` each iteration. Vue/SCSS → `npm run build`; `public/css/admin.css` hand-edited/served directly.
