...
We are about to begin a new session: **120. Filament Custom Theme — Admin Panel Tailwind Build**.
...
3. Open `sessions/120. Filament Custom Theme — Admin Panel Tailwind Build.md` and read the session prompt carefully.
