...
We are about to begin a new session: **114. Permissions Audit & Coverage**.
...
3. Open `sessions/114. Permissions Audit & Coverage.md` and read the session prompt carefully.
