...
We are about to begin a new session: **114. Demo Role & Read-Only Enforcement**.
...
4. Open `sessions/114. Demo Role & Read-Only Enforcement.md` and read the session prompt carefully.
