We are about to begin a new session: **098. Additional Widget Types — Calendar, Chart & Video**.
...
3. Open `sessions/098. Additional Widget Types — Calendar, Chart & Video.md` and read the session prompt carefully.
