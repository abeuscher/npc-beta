...
- **D3 — Donations vertical** (~2–3). The hardest remaining entanglement (funds, receipts, transactions); expected to force surface 7 (email-template registry) and surface 9 (contact-extension socket) into PROVEN.
