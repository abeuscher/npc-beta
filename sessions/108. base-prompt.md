...
We are about to begin a new session: **108. Beta-One Bug Fixes & Migration Squash**.
...
3. Open `sessions/108. Beta-One Bug Fixes & Migration Squash.md` and read the session prompt carefully.
