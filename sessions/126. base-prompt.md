...
We are about to begin a new session: **126. Logo Garden Widget & Demo Collection Seeding**.
...
3. Open `sessions/126. Logo Garden Widget & Demo Collection Seeding.md` and read the session prompt carefully.
