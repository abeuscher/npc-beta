...
We are about to begin a new session: **126. Widget — Alternating Panels**.
...
3. Open `sessions/126. Widget — Alternating Panels.md` and read the session prompt carefully.
