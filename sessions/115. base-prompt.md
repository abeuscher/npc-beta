...
We are about to begin a new session: **115. Housekeeping & Consistency Audit**.
...
3. Open `sessions/115. Housekeeping & Consistency Audit.md` and read the session prompt carefully.
