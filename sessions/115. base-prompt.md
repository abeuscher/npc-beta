...
We are about to begin a new session: **115. Demo Signup & Account Expiry**.
...
4. Open `sessions/115. Demo Signup & Account Expiry.md` and read the session prompt carefully.
