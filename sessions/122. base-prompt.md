...
We are about to begin a new session: **122. Widget — Video & Image Background**.
...
3. Open `sessions/122. Widget — Video & Image Background.md` and read the session prompt carefully.
