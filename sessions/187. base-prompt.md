We are about to begin a new session: **187. Content Template Editor & Per-Type Defaults**.
...
3. Open `sessions/187. Content Template Editor & Per-Type Defaults.md` and read the session prompt carefully.
