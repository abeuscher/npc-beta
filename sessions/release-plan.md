...
#### E6. Theme Colors Refactor — **superseded & absorbed by the Theme & Template Re-Taxonomy arc (arc-content sessions 297 / 300 / 301; prompts/stub at session-295 close-prep)**
...
36. **E6.** Theme Colors Refactor → **superseded by the Theme & Template Re-Taxonomy arc; arc-content sessions 297 / 300 / 301 (+ 302 tail)** *(precedes D2 per Rule 8; arc session 1 — 297 Theme Color Foundation — ✅ closed at session 297; arc session 2 — 300 Widget Color-Token Consumption (the risk session) — ✅ closed at session 300; arc session 3 — 301 Schemes, Template Page-Shell & Chrome, Shared Resolver — ✅ closed at session 301; only the optional naming/IA polish tail remains = session **302** (drafted, arc-closing — § E6 fully retired when 302 closes); sessions 298/299 are the interleaved test-feedback-loop early-lift of § D4; canonical design in the `session-outlines.md` arc stub)*
