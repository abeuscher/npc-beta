...
44. **E18.** Record-duplicate affordance — events / pages / posts / products *(promoted from housekeeping inbox at s313 close; "everything is in place for it" per user; touches 4 resources × 2 surfaces — list-level duplicate action + record-page duplicate action; pattern already established on similar resources)*
