...
- **gate:** release
- **prerequisites:** 287; `sessions/public website/pricing-chart-widget-spec.md` (data shape + visual intent, four planning-time decisions baked in)
...
43. **E15.** Table widget *(promoted from housekeeping inbox at 282 audit; 311 attempted, rewound — success criterion revised to a rich-text toolbar Insert-Table affordance, not a standalone widget; prompt rewrite pending before next slot)*
...
46. **E20.** Media duplicate + unused finder *(promoted from housekeeping inbox at s313 close; admin-tool build — scanner over media-library entries plus embedded-media references inside widget configs, hero backgrounds, page-content rich-text fields, and any other surface that references media. Outputs a list of duplicates and unreferenced files for operator triage. Tool-building scope.)*
47. **E16.** Header / footer defaults overhaul *(promoted from housekeeping inbox at 282 audit)*
48. **E17.** Borders pass — widget controls + columns *(promoted from housekeeping inbox at 282 audit)*
