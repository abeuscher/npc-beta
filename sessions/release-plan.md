...
- **gate:** release
- **prerequisites:** none (CRM-side contract is at v1.2.0; this is FM-side capability work)
...
2. **A2.** Fleet Manager — node operations parity *(may be 2 sessions)*
3. **E1.** Onboarding/Install Dashboard Widget *(precedes A3 for first-run experience)*
4. **A3.** Multi-node operational readiness
5. **A4.** DB wipe + backup recovery — runbook polish
6. **A5.** 2FA for admin accounts
7. **E3.** Rich Text Custom Fields *(precedes B2 — HTML in import data)*
8. **E2.** Importer Mapping Page UX *(precedes B2)*
9. **B1.** Organizations Model Overhaul
10. **B2.** Onboarding rehearsal cluster
11. **E10.** Full-Width Architecture Enforcement
12. **E11.** Page Builder Focus-Scroll Clamp
13. **C1.** Notes Permissions (feature half)
14. **E9.** Widget Help Authoring
15. **C2.** Event Ticket Tiers
16. **C3.** Permission audit + Concurrent admin editing + Accidental public exposure
17. **E4.** Stripe Checkout Branding *(precedes C4)*
18. **C4.** Donation-to-acknowledgment loop
19. **C5.** Event with everything
20. **C6.** Membership renewal cycle
21. **C7.** Email at volume
22. **E5.** Mobile Type Scaling *(precedes D2 per Rule 8)*
23. **E6.** Theme Colors Refactor *(precedes D2 per Rule 8)*
24. **E7.** Column-Layout Mobile Collapse *(precedes D2 per Rule 8)*
25. **E8.** UI/UX Sprint
26. **E12.** Housekeeping Batch 2
27. **D1.** Scale rehearsal
28. **D2.** Compatibility cluster
29. **D3.** Integration retest *(absolute last rehearsal per Rule 9)*
30. **E13.** Help docs body content
31. **E14.** Third-Party Licensing Compliance Audit
32. **T1.** Code Review & Cleanup + Migration Squash *(terminal per Rule 10)*
