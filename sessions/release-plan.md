...
36. **E6.** Theme Colors Refactor → **superseded by the Theme & Template Re-Taxonomy arc, sessions 297–299+** *(precedes D2 per Rule 8; arc session 1 — 297 Theme Color Foundation — ✅ closed at session 297; 298 widget-consumption audit prompts drafted, 299 schemes/chrome/resolver next; canonical design in the `session-outlines.md` arc stub)*
