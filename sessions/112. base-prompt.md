...
We are about to begin a new session: **112. Password Generator & Data Generator Audit**.
...
3. Open `sessions/112. Password Generator & Data Generator Audit.md` and read the session prompt carefully.
