...
**Successor concern, not part of this arc:** visual / computed-style parity at the rendered-DOM layer (catches Quill-injected CSS leaks and namespace-scoping bugs like the double-bullet on `<ul><li>` items that the HTML-layer guard cannot see) — drafted as session 308.
