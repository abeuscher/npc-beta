...
We are about to begin a new session: **116. CMS Content Export/Import**.
...
4. Open `sessions/116. CMS Content Export/Import.md` and read the session prompt carefully.
