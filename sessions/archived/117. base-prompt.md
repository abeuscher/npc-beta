...
We are about to begin a new session: **117. Permissions Framework & Coverage Audit**.
...
3. Open `sessions/117. Permissions Framework & Coverage Audit.md` and read the session prompt carefully.
