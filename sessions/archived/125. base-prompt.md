...
We are about to begin a new session: **125. Build Server Settings & CI Pipeline**.
...
3. Open `sessions/125. Build Server Settings & CI Pipeline.md` and read the session prompt carefully.
