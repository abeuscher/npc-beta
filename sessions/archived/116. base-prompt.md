...
We are about to begin a new session: **116. Code Review & Framework Alignment Audit**.
...
3. Open `sessions/116. Code Review & Framework Alignment Audit.md` and read the session prompt carefully.
