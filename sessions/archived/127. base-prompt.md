...
We are about to begin a new session: **127. Board Members & Three Buckets Widgets**.
...
3. Open `sessions/127. Board Members & Three Buckets Widgets.md` and read the session prompt carefully.
