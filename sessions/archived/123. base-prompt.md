...
We are about to begin a new session: **123. Tailwind Removal & Build Server Integration**.
...
3. Open `sessions/123. Tailwind Removal & Build Server Integration.md` and read the session prompt carefully.
