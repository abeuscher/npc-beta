...
We are about to begin a new session: **142. Inline JS/CSS Extraction & Migration Squash**.
...
3. Open `sessions/142. Inline JS/CSS Extraction & Migration Squash.md` and read the session prompt carefully.
