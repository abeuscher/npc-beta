We are about to begin a new session: **064. Sample Data Generator Library**.

Please open `sessions/064. Sample Data Generator Library.md` and read the session prompt carefully. Summarise your understanding and confirm you are ready to proceed before touching anything.
...
- **Session log**: write a log file at `sessions/064. Sample Data Generator Library — Log.md` summarising what was built, what changed, and any deferred decisions.
...
- **Commit**: stage all changed files (including the log and updated outlines), commit to a feature branch named `session-064`, and notify the user. Do not push — the user will push and merge when ready.
