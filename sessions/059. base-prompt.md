We are about to begin a new session: **059. Password Reset**.

Please open `sessions/059. Password Reset.md` and read the session prompt carefully. Summarise your understanding and confirm you are ready to proceed before touching anything.
...
- **Session log**: write a log file at `sessions/059. Password Reset — Log.md` summarising what was built, what changed, and any deferred decisions.
...
- **Commit**: stage all changed files (including the log and updated outlines), commit to a feature branch named `session-059`, and notify the user. Do not push — the user will push and merge when ready.
