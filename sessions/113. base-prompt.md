...
We are about to begin a new session: **113. Local Dev Environment — WSL2 Migration**.
...
3. Open `sessions/113. Local Dev Environment — WSL2 Migration.md` and read the session prompt carefully.
