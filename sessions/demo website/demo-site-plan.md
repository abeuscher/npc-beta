...
**Order:** A ✅ → **C (326) ✅** → **B (327) ✅** → **D (328) ✅** → **329 (upload lockdown) ✅** → **E (336) ✅** → **F (337) ✅**. The driver.js tour framework (the marketing-ready gate) follows F — **drafted + scoped as session 338** (admin-panel walkthrough; see `sessions/338. …`). It is the last piece before demo v1 is complete.
