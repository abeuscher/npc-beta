...
| **E** | **Demo node assembly** | Header/footer duplication (§5); demo:reset extended to seed the curated showcase pages so they survive the daily wipe; **resolve the Faker/`--no-dev` blocker** (§6). | A, C, B, D, 329 |
...
**Order:** A ✅ → **C (326) ✅** → **B (327) ✅** → **D (328) ✅** → **329 (upload lockdown)** → E → F (E gates on everything as it assembles the curated pages).
