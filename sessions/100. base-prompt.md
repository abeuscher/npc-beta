We are about to begin a new session: **100. Template Manager UI & Page Creation Flow**.
...
3. Open `sessions/100. Template Manager UI & Page Creation Flow.md` and read the session prompt carefully.
