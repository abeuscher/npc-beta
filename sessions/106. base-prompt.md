...
We are about to begin a new session: **106. Transaction Ledger Cleanup & Seeder**.
...
3. Open `sessions/106. Transaction Ledger Cleanup & Seeder.md` and read the session prompt carefully.
