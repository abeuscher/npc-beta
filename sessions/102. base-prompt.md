We are about to begin a new session: **102. Stripe Payment Methods & QuickBooks Connection**.
...
3. Open `sessions/102. Stripe Payment Methods & QuickBooks Connection.md` and read the session prompt carefully.
