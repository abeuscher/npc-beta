...
We are about to begin a new session: **109. Deletion Guards & Archive Pattern**.
...
3. Open `sessions/109. Deletion Guards & Archive Pattern.md` and read the session prompt carefully.
