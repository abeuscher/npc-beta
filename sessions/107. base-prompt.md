...
We are about to begin a new session: **107. Paid Event Registration & Membership Checkout**.
...
3. Open `sessions/107. Paid Event Registration & Membership Checkout.md` and read the session prompt carefully.
