...
namespace Plugins\MemberPortal\Widgets\PortalSignup;
...
class PortalSignupDefinition extends WidgetDefinition
{
    ...
    {
        return "@include('plugin-member-portal-widgets::PortalSignup.template')";
    }
    ...
    {
        return ['js' => ['plugins/MemberPortal/Widgets/PortalSignup/script.js']];
    }
