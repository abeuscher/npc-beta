...
namespace Plugins\Events\Filament\Resources;

use Plugins\Events\Filament\Resources\EventResource\Pages;
...
class EventResource extends Resource
{
    ...
    {
        return [
            ['key' => 'event_id',            'header' => 'event_id',            'value' => fn (\App\Models\EventRegistration $r) => $r->event_id,                       'type' => 'number'],
            ...
            ['key' => 'registered_at',       'header' => 'registered_at',       'value' => fn (\App\Models\EventRegistration $r) => $r->registered_at?->toDateTimeString(), 'type' => 'datetime'],
            ...
            ['key' => 'created_at',          'header' => 'created_at',          'value' => fn (\App\Models\EventRegistration $r) => $r->created_at?->toDateTimeString(),    'type' => 'datetime'],
        ];
    }
    ...
    public static function exportColumnSpec(): array
    {
        return [
            ...
            ['key' => 'starts_at',                 'header' => 'starts_at',                 'value' => fn (Event $e) => $e->starts_at?->toDateTimeString(), 'type' => 'datetime'],
            ['key' => 'ends_at',                   'header' => 'ends_at',                   'value' => fn (Event $e) => $e->ends_at?->toDateTimeString(),   'type' => 'datetime'],
