...
namespace Plugins\Products\Widgets\ProductCarousel;
...
class ProductCarouselDefinition extends WidgetDefinition
{
    ...
    {
        return "@include('plugin-products-widgets::ProductCarousel.template')";
    }

    public function assets(): array
    {
        return [
            'scss' => ['plugins/Products/Widgets/ProductCarousel/styles.scss'],
            'js'   => ['plugins/Products/Widgets/ProductCarousel/script.js'],
            'libs' => ['swiper'],
        ];
    }
