...
namespace Plugins\Memberships\Widgets\PricingChart;
...
class PricingChartDefinition extends WidgetDefinition
{
    ...
    {
        return "@include('plugin-memberships-widgets::PricingChart.template')";
    }
    ...
    {
        return ['scss' => ['plugins/Memberships/Widgets/PricingChart/styles.scss']];
    }
