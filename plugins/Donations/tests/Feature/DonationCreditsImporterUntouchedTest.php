...
it('Donations importer source files contain no DonationCredit references', function () {
    $sources = [
        base_path('plugins/Donations/Filament/Pages/ImportDonationsPage.php'),
        base_path('plugins/Donations/Filament/Pages/ImportDonationsProgressPage.php'),
        base_path('plugins/Donations/Importers/DonationFieldRegistry.php'),
    ];
