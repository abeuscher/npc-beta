...
namespace Plugins\Donations\Filament\Resources;

use App\Filament\Resources\ContactResource;
use Plugins\Donations\Filament\Resources\DonationResource\Pages;
use Plugins\Donations\Filament\Resources\DonationResource\RelationManagers;
...
class DonationResource extends Resource
{
    ...
    {
        return [
            ['key' => 'amount',                'header' => 'amount',                'value' => fn (Donation $d) => $d->amount,                          'type' => 'number'],
            ['key' => 'donated_at',            'header' => 'donated_at',            'value' => fn (Donation $d) => $d->started_at?->toDateTimeString(), 'type' => 'datetime'],
            ...
            ['key' => 'created_at',            'header' => 'created_at',            'value' => fn (Donation $d) => $d->created_at?->toDateTimeString(),  'type' => 'datetime'],
        ];
    }
}
