...
namespace Plugins\Donations\Filament\Pages;

use App\Filament\Actions\EmailPreviewWizardAction;
use Plugins\Donations\Mail\DonationReceipt as DonationReceiptMail;
...
class DonorsPage extends Page implements HasTable
{
    ...
    protected static string $view = 'plugin-donations::filament.donors';
