...
namespace Plugins\Donations\Mail;
 ...
 *
 * Distinct from Plugins\Donations\Mail\DonationReceipt, which is the annual,
 * aggregated year-end statement sent manually from the Giving Summary page.
 * This one is queued automatically by the PromotePaidDonations listener the
 * moment a gift clears (the Payments webhook dispatches CheckoutSettled) and
