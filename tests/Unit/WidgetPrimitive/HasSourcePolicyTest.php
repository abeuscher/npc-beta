...
it('applies the declared policy on Page (demo, google_docs, llm_synthesis)', function () {
    $page = new Page;
...
it('applies the declared policy on Contact (import, demo)', function () {
    $contact = new Contact;
...
it('applies the declared policy on Donation (import, stripe_webhook) — never DEMO', function () {
