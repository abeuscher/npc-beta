...
it('blog_listing widget renders without background_color or text_color reads', function () {
    $html = Blade::render(
        file_get_contents(base_path('vendor/nonprofitcrm/blog/Widgets/BlogListing/template.blade.php')),
        [
            'config' => [
                'heading'          => 'Posts',
...
it('events_listing widget renders without background_color or text_color reads', function () {
    $html = Blade::render(
        file_get_contents(base_path('vendor/nonprofitcrm/events/Widgets/EventsListing/template.blade.php')),
        [
            'config' => [
                'heading'          => 'Events',
                'content_template' => '<h3>{{title}}</h3>',
