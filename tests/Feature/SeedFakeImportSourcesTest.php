...
it('each seeded field map covers every canonical CSV header', function () {
    ...
    $pairs = [
        ...
        'Demo Fake Data — Donations'       => ['donations_field_map',   CsvTemplateService::headersFor('donations'),       []],
        'Demo Fake Data — Memberships'     => ['memberships_field_map', CsvTemplateService::headersFor('memberships'),     []],
